$(document).ready(function() {
    ...
    $(window).scroll(function(scroll) {
        ...
        if(scroll >= navStart) {
            ...
            $('[data-fb]').animate({opacity: '1'}, 25);
            $('#access-jump').animate({opacity: '1'}, 25);
             $('.navbar').animate({width: '100%'}, 50);
            if(window.matchMedia("screen and (max-width: 630px)").matches) {
            $('[data-fb=data-image]').animate({opacity: '0'}, 25);
            $('#access-jump').animate({opacity: '0'}, 25);
            }   
            
            if(window.matchMedia("(min-width: 1715px)").matches) {
                $('#access-jump').animate({top: '1%'}, 25);
                ...
                $('#access-jump').animate({top: '1%'}, 25);
                $('[data-fb=data-image]').animate({top: '.75%'}, 25);
                $('[data-fb=data-image]').animate({opacity: '1'}, 25);
            $('#access-jump').animate({opacity: '1'}, 25);
            }
        }
        else {
            ...
            $('.navbar-right').animate({marginRight: '1em'}, 0);
                ...
                $('#access-jump').animate({top: '32%'}, 10);
                $('[data-fb=data-image]').animate({top: '32%'}, 10);
                $('#access-jump').animate({opacity: '1'}, 25);
                $('[data-fb=data-image]').animate({opacity: '1'}, 25);
            }
            else {
